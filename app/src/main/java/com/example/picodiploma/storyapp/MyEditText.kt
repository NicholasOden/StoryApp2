...
class MyEditText : AppCompatEditText, View.OnTouchListener {
    ...
    override fun onDraw(canvas: Canvas) {
        ...
        if (error != null) setErrorIconVisible(true)
    }
    ...
    private fun init() {
        ...
        errorIcon = ContextCompat.getDrawable(
            context,
    ...
    private fun setErrorIconVisible(visible: Boolean) {
        error = if (visible) errorMessage else null
        setCompoundDrawablesWithIntrinsicBounds(null, null, errorIcon.takeIf { visible }, null)
    }
